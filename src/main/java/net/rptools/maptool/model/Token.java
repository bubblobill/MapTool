...
public class Token implements Cloneable {
    ...
    public static Token fromDto(TokenDto dto) {
        ...
        if (dto.hasHaloColor()) {
            token.setHaloColor(new Color(dto.getHaloColor().getValue()));
        }
        if(dto.hasHalo()){
            token.setHalo(Halo.fromDto(dto.getHalo()));
        }
    ...
    public boolean hasHalo() {
        return halo != null || haloColor != null || haloColorValue != null;
    }

    public Color getHaloColor() {
            if (halo != null) {
                return halo.getColour();
            } else if (haloColor != null) {
                return haloColor;
            } else if (haloColorValue != null) {
                setHaloColor(new Color(haloColorValue));
                return haloColor;
            } else {
                return null;
            }
    ...
    public void updateProperty(Zone zone, Update update, List<TokenPropertyValueDto> parameters) {
        ...
        switch (update) {
            ...
            case setXY:
                ...
                break;
              case setHalo:
                setHalo(!parameters.isEmpty() ? Halo.fromDto(parameters.getFirst().getHalo()) : null);
                break;
            case setHaloColor:
                setHaloColor(
    ...
    public TokenDto toDto() {
        ...
        if (haloColor != null) {
            dto.setHaloColor(Int32Value.of(haloColor.getRGB()));
        }
